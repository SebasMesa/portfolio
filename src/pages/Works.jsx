...
import MetallicTitle from '../ui/MetallicText';
  ...
  return (
    <>
      ...
      <section className='mt-[2rem] relative'>
        <h2 className='text-glass-macos md:text-[3.5rem] font-bold text-[2.5rem] text-center'>
        ...
        <section>
          <div
            className='border border-[#333] dark:border-[#444] px-[3rem] pt-4 rounded-[1rem] hover:scale-105 transition-all duration-300 cursor-pointer mb-[2rem] overflow-hidden h-[65vh] group bg-glass_gradient'
          >
            ...
            <p className='text-[1.3rem] text-[#a1a1a1] md:w-[55%]'>
              Con ProRoute aprendes a programar 💻 desde cero, acompañado de una comunidad que impulsa tu crecimiento.
            </p>
