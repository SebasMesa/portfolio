    ...
    return (
        <>
            <div className='flex flex-col items-center gap-5 mt-[2rem] mb-[8rem]'>
                ...
                <button className='text-[1.1rem] mt-[2rem] px-6 py-3 rounded-[10px]  text-white hover:opacity-80 transition-opacity duration-300 bg-glass-mac font-semibold'>Hablemos de tu proyecto</button>
            </div>
